...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-=dgct-s09_3^b%(&r2xjg_42fzz+&x^b@c1gjes6=oh3==l@5-')
...
# Also add the external hostname if provided by Render
...
WSGI_APPLICATION = 'taskbuddy.wsgi.application'
